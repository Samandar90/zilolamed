  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col p-6">
        ...
        <div className="relative z-20 mt-auto flex items-center gap-2 pt-5">
          <BookButton
            prefill={{ doctor: { name: doctor.name, primary: doctor.primary }, source: "doctor-card" }}
            size="sm"
            variant="primary"
            className="flex-1"
          >
          ...
          <span className="grid h-9 w-9 shrink-0 place-items-center rounded-full border border-line text-ink-800 transition-all duration-300 group-hover:border-transparent group-hover:bg-ink-900 group-hover:text-white">
